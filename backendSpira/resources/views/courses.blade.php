...
@section('content')
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="body tables">
            <button class="btn btn-raised btn-primary  waves-effect" href="javascript:void(0);" data-toggle="modal" data-target="#add-course">
                Crear
            </button><br><br>
                    ...
                    <tbody>
                        @foreach ($courses as $course)
                            <tr>
                                ...
                                <td class="text-center"> {{ $course->hourly_intensity }} </td>

                                <td class="text-center">
                                    <a href="{{ route('courses.edit', ['id' => $course->id]) }}" class="btn btn-raised btn-primary waves-effect">Edit</a>
                                    
                                    <button onclick="deleteCourse({{ $course->id }})" class="btn btn-raised btn-danger waves-effect">Delete</button>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="body">
                        <form id="form-course" class="form-horizontal">
                            @csrf
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8 form-group">
                                    <input name="hourly_intensity" type="number" id="hourly_intensity"
                                        class="form-control">
                                </div>
                            </div>
                        </form>
