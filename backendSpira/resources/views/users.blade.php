...
@section('content')
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="body table">
            ...
            <a class="btn btn-raised btn-primary  waves-effect" href="javascript:void(0);" data-toggle="modal" data-target="#add-user">
                Crear
            </a><br><br>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('users.edit', ['id' => $user->id]) }}"
                                        class="btn btn-raised btn-primary  waves-effect">Edit</a>
                                    <a onclick="deleteUser({{ $user->id }})" class="btn btn-raised btn-danger waves-effect">Delete</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                    ...
                    <div class="body">
                        <form id="form-user" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-10 col-md-10 col-sm-8 form-group">
                                    <select name="id_profile" class="form-control show-tick ms select2"
                                        data-placeholder="Select" id="id_profile">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default  waves-effect store-user">Crear</button>
