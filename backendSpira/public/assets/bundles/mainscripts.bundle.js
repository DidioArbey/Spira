...
$.AdminAero = {}, $.AdminAero.options = { colors: { red: "#ec3b57", pink: "#E91E63", purple: "#ba3bd0", deepPurple: "#673AB7", indigo: "#3F51B5", blue: "#2196f3", lightBlue: "#03A9F4", cyan: "#00bcd4", green: "#4CAF50", lightGreen: "#8BC34A", yellow: "#ffe821", orange: "#FF9800", deepOrange: "#f83600", grey: "#9E9E9E", blueGrey: "#607D8B", black: "#000000", blush: "#dd5e89", white: "#ffffff" }, leftSideBar: { scrollColor: "rgba(0,0,0,0.5)", scrollWidth: "4px", scrollAlwaysVisible: !1, scrollBorderRadius: "0", scrollRailBorderRadius: "0" }, dropdownMenu: { effectIn: "fadeIn", effectOut: "fadeOut" } }, $.AdminAero.leftSideBar = {
    activate: function() {
        ...
        }), r.checkStatuForResize(!0), $(window).resize(function() { r.checkStatuForResize(!1) }), Waves.attach(".menu .list a", ["waves-block"]), Waves.init()
    },
    checkStatuForResize: function(e) {
        var a = $("body"),
            r = $(".navbar .navbar-header .bars"),
            t = a.width();
        e && a.find(".content, .sidebar").addClass("no-animate").delay(1e3).queue(function() { $(this).removeClass("no-animate").dequeue() }), t < 1170 ? (767 < t && a.addClass("ls-toggle-menu"), a.addClass("ls-closed"), r.fadeIn()) : (a.removeClass("ls-closed ls-toggle-menu"), r.fadeOut())
    },
    ...
    activate: function() {
        var r = this,
            t = $("#rightsidebar"),
            i = $(".overlay");
        $(window).on("click", function(e) { var a = $(e.target); "i" === e.target.nodeName.toLowerCase() && (a = $(e.target).parent()), !a.hasClass("js-right-sidebar") && r.isOpen() && 0 === a.parents("#rightsidebar").length && (a.hasClass("bars") || i.fadeOut(), t.removeClass("open")) }), $(".js-right-sidebar").on("click", function() { t.toggleClass("open"), r.isOpen() ? i.fadeIn() : i.fadeOut() })
    },
...
function CustomJs() {
    $(".light_dark input").on("change", function() { "dark" == $(this).val() ? $("body").addClass("theme-dark") : $("body").removeClass("theme-dark") }), $(".rtl_support input").on("change", function() {
        $(this).val();
...
}), $(function() { $('a[href="#search"]').on("click", function(e) { e.preventDefault(), $("#search").addClass("open"), $('#search > form > input[type="search"]').focus() }), $("#search, #search #close").on("click keyup", function(e) { e.target != this && "close" != e.target.id && 27 != e.keyCode || $(this).removeClass("open") }) }), $(function() {
